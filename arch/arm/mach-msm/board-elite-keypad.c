...
static uint32_t matirx_inputs_gpio_table[] = {
	GPIO_CFG(ELITE_GPIO_PWR_KEYz, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_UP,
		 GPIO_CFG_2MA),
	GPIO_CFG(ELITE_GPIO_VOL_DOWNz, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_UP,
		 GPIO_CFG_2MA),
	GPIO_CFG(ELITE_GPIO_VOL_UPz, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_UP,
		 GPIO_CFG_2MA),
};

static void elite_direct_inputs_gpio(void)
{
...
# endif
	...
	.setup_input_gpio = elite_direct_inputs_gpio,
};
